...
export type BlockType =
  | 'content' | 'callout' | 'divider'
  | 'code' | 'quote' | 'recentPages' | 'pageList' | 'columns' | 'assetPrice';
...
export type LeafBlock = ContentBlock | CalloutBlock | DividerBlock | CodeBlock | QuoteBlock | RecentPagesBlock | PageListBlock | AssetPriceBlock;
...
export const INSERTABLE_BLOCKS: readonly BlockType[] = ['content', 'columns', 'callout', 'quote', 'code', 'divider', 'recentPages', 'pageList', 'assetPrice'];
